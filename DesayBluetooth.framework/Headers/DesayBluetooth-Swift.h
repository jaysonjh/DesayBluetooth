...
@property (nonatomic) enum DSBLESportType sportType;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Interval Time for check HR, Default 30min
...
typedef SWIFT_ENUM(NSUInteger, DSBLEProtocolType) {
  ...
  DSBLEProtocolTypeScalesHS11 = 11,
  DSBLEProtocolTypeShoeDS = 12,
  DSBLEProtocolTypeBand2 = 13,
};
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSUInteger, DSBLEScalesFuncType) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSUInteger, DSBLEShoeFuncType) {
